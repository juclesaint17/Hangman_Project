...
'''
import random
# hangman graphic to be display on the screen
HANGMAN_PIC = [ 
                  """
                ------
                |    |
...
class Hangman:
    ...
    # Function to display the graphical version of the hangman
...
def play_game(word_list):
    ...
    while game.num_lives > 0 and game.num_letter > 0:
        game.ask_letter()

    if game.num_lives == 0:

        print("Game over you ran out of lives...The mystery word is {}".format(game.word)) 
